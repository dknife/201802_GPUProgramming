...
class ParticleSystem :
    ...
    def initParticles(self) :
        for i in range(self.nParticles) :
            self.locIn[i*3:i*3+3] = [0, np.random.rand(1)+0.25, 0] #[0.1 * (np.random.rand(1) - 0.5), 0.5, 0.1 * (np.random.rand(1) - 0.5)]
    ...
    def show(self):
        ...
        glDispatchCompute( int(self.nParticles*3/100), 1,1)  # arraySize / local_size_x
